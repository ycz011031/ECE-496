...
HD_PWD='C:/Users/Yicheng Zhou/OneDrive/Desktop/UIUC/ECE 496/FPGA_build/CAVLC/CAVLC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log h264cavlc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source h264cavlc.tcl
